...
CREATE TABLE [dbo].[Ugyfel](
	...
	[NEV] [nvarchar](255) MASKED WITH (Function = 'partial(2,"XXXXX",2)') NOT NULL,
	[SZULEV] [int] MASKED WITH (FUNCTION = 'random(1900,2010)') NULL,
	[NEM] [nvarchar](1) NULL,
...
CREATE USER hazi WITHOUT Login;
GRANT SELECT ON Ugyfel TO hazi


EXECUTE AS User= 'hazi';
SELECT * FROM Ugyfel
REVERT